    ...
    SimpleEQAudioProcessor::createParameterLayout()
{
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>(juce::ParameterID("PeakCut Freq", 1), "PeakCut Freq", juce::NormalisableRange<float>(20.f, 20000.f, 1.f, 1.f), 750.f));
